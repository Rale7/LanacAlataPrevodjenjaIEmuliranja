...
bezuslovni_skok:call broj       {skok_literal(32, 0, 0, $2);}
        ...
        ;
uslovni_skok:   beq registar ',' registar ',' broj      {skok_literal(49, $2, $4, $6);}
        |       beq registar ',' registar ',' rec       {skok_simbol(49, $2, $4, $6);}
        |       bne registar ',' registar ',' broj      {skok_literal(50, $2, $4, $6);}
        |       bne registar ',' registar ',' rec       {skok_simbol(49, $2, $4, $6);}
        |       bgt registar ',' registar ',' broj      {skok_literal(41, $2, $4, $6);}
        |       bgt registar ',' registar ',' rec       {skok_simbol(49, $2, $4, $6);}
        ;
...
dvoadr_ins:     xchg registar ',' registar      {dvoadr_inst(64, $2, $4);}
        ...
        |       csrrd csr_registar ',' registar     {dvoadr_inst(0x90, $2, $4);}
        |       csrwr registar ',' csr_registar     {dvoadr_inst(0x94, $2, $4);}
        ;
