...
static int provera_ugradjivanje(Simbol *simbol, char oc, enum Registar r1,
                                Sekcija *sekcija) {
...
static void definisan_skok(Simbol *simbol, int kod_operacije, enum Registar rb,
                           enum Registar rc, Sekcija *sekcija) {
  if (sekcija->simbol->redosled == simbol->sekcija->simbol->redosled) {
    int pomeraj = simbol->vrednost - (sekcija->location_counter + 4);
...
static void definisan_load_imm(Simbol *simbol, enum Registar r1,
                               Sekcija *sekcija) {
...
static void definisan_load_mem(Simbol *simbol, enum Registar r1,
                               Sekcija *sekcija) {
...
static void definisan_load_reg(Simbol *simbol, enum Registar r1,
                               enum Registar r2, Sekcija *sekcija) {
  printf("Greska simbol %s je relokativan", simbol->naziv);
}

static void definisan_st_reg(Simbol *simbol, enum Registar r1, enum Registar r2,
                             Sekcija *sekcija) {
  printf("Greska simbol %s je relokativan", simbol->naziv);
}

static void definisan_st_mem(Simbol *simbol, enum Registar r1,
                             Sekcija *sekcija) {
...
static RelokacioniZapis *definisan_nrz(Simbol *simbol, Sekcija *sekcija,
                                       int lokacija, int obracanje) {
...
static void definisan_sdw(Simbol *simbol, Sekcija *sekcija, int lokacija) {
  postavi_sadrzaj(sekcija->sadrzaj, lokacija, (const char *)&simbol->vrednost,
                  4);
...
static enum Relokatibilnost definisana_relokatibilnost(Simbol *simbol,
                                                       Sekcija **sekcija) {
...
Simbol *init_definisan_simbol(const char *naziv, int vrednost,
                              Sekcija *sekcija) {
