...
static void nedefinisan_skok(Simbol* simbol, int kod_operacije,
                             enum Registar rb, enum Registar rc,
                             Sekcija* sekcija) {
  ObracanjeInstrukcije* novo_obracanje =
      init_obracanje_instrukcija(sekcija, sekcija->location_counter);
...
static void nedefinisan_load_imm(Simbol* simbol, enum Registar r1,
                                 Sekcija* sekcija) {
  ObracanjeInstrukcije* novo_obracanje =
      init_obracanje_instrukcija(sekcija, sekcija->location_counter);
  novo_obracanje->sledeci = simbol->oilista;
...
static void nedefinisan_load_mem(Simbol* simbol, enum Registar r1,
                                 Sekcija* sekcija) {
  ObracanjeInstrukcije* novo_obracanje =
      init_obracanje_instrukcija(sekcija, sekcija->location_counter);
  novo_obracanje->sledeci = simbol->oilista;
...
static void nedefinisan_load_reg(Simbol* simbol, enum Registar r1,
...
static void nedefinisan_st_reg(Simbol* simbol, enum Registar r1,
                               enum Registar r2, Sekcija* sekcija) {
  ObracanjeInstrukcije* novo_obracanje =
      init_obracanje_instrukcija(sekcija, sekcija->location_counter);
  novo_obracanje->sledeci = simbol->oilista;
...
static void nedefinisan_st_mem(Simbol* simbol, enum Registar r1,
                               Sekcija* sekcija) {
  ObracanjeInstrukcije* novo_obracanje =
      init_obracanje_instrukcija(sekcija, sekcija->location_counter);
  novo_obracanje->sledeci = simbol->oilista;
...
static RelokacioniZapis* nedefinisan_nrz(Simbol* simbol, Sekcija* sekcija,
...
static enum Relokatibilnost nedefinisana_relokatibilnost(Simbol* simbol,
                                                         Sekcija** sekcija) {
  return NEIZRACUNJIV;
}
